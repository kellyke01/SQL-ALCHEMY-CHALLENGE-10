...
def precip():
    ...
    session.close()
    #dic with the date as the key and precip as the value
...
def stations():
    ...
    # perform a query to retrieve the names of the staions
...
def temperatures():
    ...
    previousYear = dt.date(2017, 8, 23) - dt.timedelta(days=365)
    #previousYear
    # Perform a query to retrieve the  temps from the most active station from the past year
